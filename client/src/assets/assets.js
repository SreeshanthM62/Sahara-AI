...
import sahara_logo from "./Sahara.png"
import {
    PenSquare,
    Image,
    Eraser,
...
export const aiTools = [
  {
    ...
    description:
      "Generate blogs, articles, and creative content in seconds with AI.",
    icon: PenSquare,
  ...
  },
  {
    ...
    description:
      "Create engaging headlines that instantly grab attention.",
    icon: Sparkles,
  ...
  },
  {
    ...
    description:
      "Turn your imagination into stunning AI-generated artwork.",
    icon: Image,
  ...
  },
  {
    ...
    description:
      "Remove image backgrounds automatically with one click.",
    icon: Eraser,
  ...
  },
  {
    ...
    description:
      "Delete unwanted objects naturally without affecting quality.",
    icon: Scissors,
